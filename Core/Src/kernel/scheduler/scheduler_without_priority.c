...
static void __scheduler_without_priority_launch(scheduler_t* scheduler);
...
scheduler_without_priority_t* scheduler_without_priority_create()
{
	...
	if (scheduler_without_priority_g == 0)
	{
		...
		scheduler_without_priority_g->is_launched = 0;
...
static void __scheduler_without_priority_launch(scheduler_t* scheduler)
{
	...
	scheduler_without_priority->is_launched = 1;
