...
{
	test3_task0_finished = 0;
	test3_task1_finished = 0;
	test3_task2_finished = 0;
	test3_task3_finished = 0;

	test3_task0_counter = 0;
	test3_task1_counter = 0;
	test3_task2_counter = 0;
	test3_task3_counter = 0;
